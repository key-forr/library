...
namespace library.Forms.User
{
    public partial class UsersForm : Form
    {
        ...
        public UsersForm()
        {
            ...
            PanelAndFormUtils.EmbedFormInPanel(userListForm, panel_users_list);

            userAddForm = new UserAddForm(this);
            PanelAndFormUtils.EmbedFormInPanel(userAddForm, panel_user_interaction);
        }

        public void OpenUserDetails(UserConfig userConfig)
        {
            userEditForm = new UserEditForm(userConfig, this);
            PanelAndFormUtils.EmbedFormInPanel(userEditForm, panel_user_interaction);
        }
