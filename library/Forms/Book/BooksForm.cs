...
namespace library.Forms.Book
{
    public partial class BooksForm : Form
    {
        ...
        public BooksForm()
        {
            ...
            PanelAndFormUtils.EmbedFormInPanel(bookListForm, panel_books_interaction);
        }
        ...
        private void button_add_book_Click(object sender, EventArgs e)
        {
            ...
            PanelAndFormUtils.EmbedFormInPanel(childForm, panel_books_interaction);
        }
        ...
        public void OpenBookDetails(BookConfig bookConfig)
        {
            ...
            PanelAndFormUtils.EmbedFormInPanel(childForm, panel_main);
        }
