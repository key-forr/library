...
using library.Forms.Statistics;
using library.Forms.User;
using library.Forms.Warehouse;
...
namespace library.Forms
{
    public partial class HomeForm : Form
    {
        ...
        public HomeForm()
        {
            ...
            PanelAndFormUtils.EmbedFormInPanel(reminderListForm, panel_reminder_list);
        ...
        private void button_add_reminder_Click(object sender, EventArgs e)
        {
            ...
            PanelAndFormUtils.EmbedFormInPanel(reminderAddForm, panel_reminder);
        }
        ...
        private void button_books_navigation_Click(object sender, EventArgs e)
        {
            ...
            PanelAndFormUtils.EmbedFormInPanel(booksForm, panel_main);
        }
        ...
        private void button_employee_navigation_Click(object sender, EventArgs e)
        {
            ...
            PanelAndFormUtils.EmbedFormInPanel(employeeForm, panel_main);
        }
        ...
        private void button_storage_navigation_Click(object sender, EventArgs e)
        {
            ...
            PanelAndFormUtils.EmbedFormInPanel(storageForm, panel_main);
        }
        ...
        private void button_statistics_navigation_Click(object sender, EventArgs e)
        {
            ...
            PanelAndFormUtils.EmbedFormInPanel(statisticsForm, panel_main);
        }
        ...
        private void button_customer_navigation_Click(object sender, EventArgs e)
        {
            ...
            PanelAndFormUtils.EmbedFormInPanel(customerForm, panel_main);
        }
        ...
        private void button_order_navigation_Click(object sender, EventArgs e)
        {
            SetActiveNavigationButton(button_order_navigation);

            bookingForm = new OrderForm();
            PanelAndFormUtils.EmbedFormInPanel(bookingForm, panel_main);
        }
        ...
        private void button_order_navigation_MouseEnter(object sender, EventArgs e)
        {
            if (!IsButtonActive(button_order_navigation))
            {
                ButtonUtils.AnimateNavigationButton(button_order_navigation, true, Color.White, Color.FromArgb(22, 26, 50));
            }
        }

        private void button_order_navigation_MouseLeave(object sender, EventArgs e)
        {
            if (!IsButtonActive(button_order_navigation))
            {
                ButtonUtils.AnimateNavigationButton(button_order_navigation, false, Color.White, Color.FromArgb(22, 26, 50));
            }
        }
