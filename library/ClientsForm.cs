...
namespace library
{
    public partial class ClientsForm : Form
    {
        ...
        public ClientsForm()
        {
            ...
            PanelAndFormManager.EmbedFormInPanel(clientAddForm, panel_client_interaction);

            clientsListForm = new ClientsListForm(this);
            PanelAndFormManager.EmbedFormInPanel(clientsListForm, panel_clients_list);
        }
        ...
        public void OpenClientDetails(ClientConfig clientConfig)
        {
            ...
            PanelAndFormManager.EmbedFormInPanel(clientEditForm, panel_client_interaction);
        }
